    ...
    const fetchSubmissions = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/api/btechsubmissions-and-non-submissionscompiler/${week}?courseYear=${courseYear}&company=${companyFilter}`
        );
...
export default BtechweekSubmissions;
