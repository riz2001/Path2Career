    ...
    const fetchSubmissions = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/api/mbasubmissions-and-non-submissions/${week}?courseYear=${courseYear}&company=${companyFilter}`
        );
